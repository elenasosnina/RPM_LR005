...
namespace ClassLibrary1
{
    public class Auditory
    {
        ...
        public List<Equipment> EquipmentList { get; } // Ссылка на оборудование
        public Auditory(string name, Employee employee, byte places, byte window, List<Equipment> equipmentList) // конструктор 
        {
            Name = name;
            Employee = employee;
            Places = places;
